...
function ItemDiscription() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:5000/api/products/${productToView._id}`) // Replace with your API endpoint for fetching item details
      .then((response) => {
            ...
            <div className="shop_detail_1 clearfix">
                      ...
                      <div className="item active">
                        <div className="mag">
                          <div className="magnify">
                            <div className="magnify">
                              <img
                                src={`http://localhost:5000/${productToView?.image}`}
              ...
              <div className="col-sm-6">
                <div className="center_detail_2_right clearfix">
                  ...
                  <h4>
                    <span className="span_2 col_1">
                      Rs.{productToView.price}
                    </span>
                  </h4>
                  <p>
